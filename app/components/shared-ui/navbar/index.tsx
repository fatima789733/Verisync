        ...
        <div className="w-full h-[68px] mx-auto flex justify-between items-center p-[12px]">
          ...
          <div className="hidden lg:block">
            <Link
              ...
              className="cursor-pointer backdrop-blur-sm hover:-translate-y-1 bg-[#7E61FF0D] flex items-center justify-center gap-2 font-inter w-[140px] text-[16px] h-[50px] bg-opacity-50 text-white rounded-[6px] hover:bg-opacity-70 transition duration-300"
            >
              <span>Get Token</span>
